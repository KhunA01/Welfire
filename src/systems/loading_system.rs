...
pub fn load_player_assets(mut commands: Commands, asset_server: Res<AssetServer>) {
    let animations: PlayerAnimations = PlayerAnimations {
        ...
        left_walk: asset_server.load("animations/Sword And Shield Strafe.glb#Animation0"),
        right_walk: asset_server.load("animations/Sword And Shield Strafe (1).glb#Animation0"),
